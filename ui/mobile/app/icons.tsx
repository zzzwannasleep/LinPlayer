...
const P: Record<string, [string, Opt?]> = {
  ...
  /** 屏蔽(划掉的眼睛)。设置里的「已屏蔽的内容」和卡片角标用。 */
  eyeoff: [`<path d="M10.6 6.2A9.6 9.6 0 0 1 12 6c5 0 9 4.5 9 6 0 .7-.9 2.1-2.4 3.4"/><path d="M6.3 8.3C4.1 9.8 3 11.4 3 12c0 1.5 4 6 9 6 1.4 0 2.6-.3 3.7-.8"/><path d="M9.9 9.9a3 3 0 0 0 4.2 4.2"/><path d="m3.5 3.5 17 17"/>`],
