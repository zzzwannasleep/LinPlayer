...
class DesktopThemeExtension extends ThemeExtension<DesktopThemeExtension> {
  ...
  factory DesktopThemeExtension.fallback(Brightness brightness) {
    ...
    return const DesktopThemeExtension(
      ...
      backgroundGradientStart: Color(0xFFF8FAFD),
      backgroundGradientEnd: Color(0xFFEFF3F8),
      sidebarColor: Color(0xF7FFFFFF),
      surface: Color(0xFFFFFFFF),
      surfaceElevated: Color(0xFFF6F9FD),
      border: Color(0x1F3B4A5A),
      textPrimary: Color(0xFF1A2433),
      textSecondary: Color(0xFF4F5F73),
      textMuted: Color(0xFF76859A),
      link: Color(0xFF2C5FB8),
      accent: Color(0xFF3D8B40),
      headerBackground: Color(0xCFFFFFFF),
      headerScrolledBackground: Color(0xEEFFFFFF),
      topTabBackground: Color(0xDDE9F0F8),
      topTabActiveBackground: Color(0xFFFFFFFF),
      topTabInactiveForeground: Color(0xFF6B7B90),
      categoryOverlay: Color(0x3DFFFFFF),
      posterOverlay: Color(0x52000000),
      posterControlBackground: Color(0xD6FFFFFF),
      posterBadgeBackground: Color(0xFF3D8B40),
      shadowColor: Color(0x1A000000),
      hover: Color(0x1A2C5FB8),
