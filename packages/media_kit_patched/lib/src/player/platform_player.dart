...
class PlayerConfiguration {
  ...
  /// Extra mpv options to be passed directly to libmpv before initialization.
  /// Each entry should be in the form `key=value`; if `=` 不存在则默认使用 `yes`。
  /// 仅在原生端生效（Windows/macOS/Linux/Android/iOS）。
  final List<String> extraMpvOptions;
