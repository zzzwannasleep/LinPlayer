...
| `LP_SYNC_PROXY_BASE` | Trakt / Bangumi 登录(自建 OAuth 代理) | 两个同步服务登不上 | **secret** |
| `LP_SYNC_PROXY_KEY` | 同上(访问代理的共享密钥) | 同上 | **secret** |
| `LP_BANGUMI_REDIRECT_URI` | Bangumi OAuth 回调 | Bangumi 登录跳不回来 | **secret** |
